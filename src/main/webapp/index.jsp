...
<main>
    <section class="hero">
        <div class="hero__contenido">
            ...
            <p class="hero__desc">Descubre la magia de la repostería artesanal. Ingredientes frescos, recetas de toda la vida y mucho amor en cada bocado.</p>
            <div class="hero__botones">
                <a href="${pageContext.request.contextPath}/jsp/public/catalogo.jsp" class="btn btn--primario">Ordenar Ahora</a>
                <a href="${pageContext.request.contextPath}/jsp/public/catalogo.jsp" class="btn btn--outline">Ver Catálogo</a>
            </div>
        </div>
    ...
    <section class="seccion">
        ...
        <div class="catalogo-grid" style="max-width:var(--container-max);margin:0 auto;">
            <div class="tarjeta-producto">
                <div class="tarjeta-producto__img-wrap"><div class="img-placeholder" style="height:200px;"></div></div>
        ...
        <div style="text-align:center;margin-top:2rem;">
            <a href="${pageContext.request.contextPath}/jsp/public/catalogo.jsp" class="btn btn--primario">Explorar todos los dulces</a>
        </div>
    </section>

    <section class="seccion seccion--alterna">
        <span class="etiqueta">NOTICIAS Y NOVEDADES</span>
        <h2 class="seccion__titulo">Mantente al tanto de nuestras últimas<br>historias y secretos culinarios.</h2>
        <div class="noticias-grid">
            <div class="tarjeta-noticia">
                ...
                <div class="tarjeta-noticia__cuerpo">
                    ...
                    <p class="tarjeta-noticia__texto">Descubre las técnicas ancestrales que dan vida a nuestro pan más especial.</p>
            ...
            <div class="tarjeta-noticia">
                ...
                <div class="tarjeta-noticia__cuerpo">
                    ...
                    <p class="tarjeta-noticia__texto">Un vistazo a la precisión y creatividad detrás de nuestras tartas personalizadas.</p>
                    <a href="#" class="enlace-detalle">Leer más →</a>
                </div>
            </div>
            <div class="tarjeta-noticia">
                ...
                <div class="tarjeta-noticia__cuerpo">
                    ...
                    <p class="tarjeta-noticia__texto">Acompáñanos en el proceso diario de creación de nuestros dulces artesanales.</p>
    ...
    <section class="seccion">
        ...
        <div class="pasos">
            <div class="paso"><div class="paso__numero">1</div><h3 class="paso__titulo">Elige</h3><p class="paso__desc">Selecciona tus dulces favoritos de nuestro catálogo.</p></div>
            <div class="paso"><div class="paso__numero">2</div><h3 class="paso__titulo">Confirma</h3><p class="paso__desc">Contáctanos para validar disponibilidad y fecha.</p></div>
            <div class="paso"><div class="paso__numero">3</div><h3 class="paso__titulo">Abona</h3><p class="paso__desc">Realiza el pago del abono para asegurar tu pedido.</p></div>
            <div class="paso"><div class="paso__numero">4</div><h3 class="paso__titulo">Disfruta</h3><p class="paso__desc">Recoge tu pedido y disfruta en casa.</p></div>
        </div>
    </section>
</main>
